...
function StatCard({ num, suffix, label }) {
  ...
  return (
    <div ref={ref}
      className="flex-1 px-6 py-5 border-r border-[rgba(0,255,136,0.15)] last:border-r-0
        relative overflow-hidden group transition-all duration-300 hover:bg-[rgba(0,255,136,0.04)] cursor-default">
...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center pt-24 pb-16 px-6 md:px-14 relative z-10">
      <div className="flex flex-col lg:flex-row items-start justify-between gap-12 max-w-7xl mx-auto w-full">
        ...
        <div className="flex-1 max-w-2xl">
          <div className="inline-flex items-center gap-2 font-sans text-[0.68rem] tracking-[0.14em] uppercase
            text-green-primary border border-[rgba(0,255,136,0.35)] bg-[rgba(0,255,136,0.06)] px-4 py-2 mb-8">
          ...
          <h1 className="font-bold leading-[0.93] tracking-tighter mb-5" style={{ fontSize: 'clamp(3.8rem,8vw,7rem)' }}>
            ...
            <span className="glitch text-green-primary block" data-text="Devale"
              style={{ textShadow: '0 0 40px rgba(0,255,136,0.35)' }}>Devale</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <a href="#contact"
              ...
              style={{ boxShadow: '0 0 28px rgba(0,255,136,0.3)' }}>
              Get In Touch
            </a>
            <a href="https://github.com/santhosh-devale" target="_blank" rel="noreferrer"
              className="inline-flex items-center gap-2 font-sans text-[0.78rem] tracking-widest uppercase
                text-green-primary border border-[rgba(0,255,136,0.35)] px-6 py-3
        ...
        <div className="flex flex-col items-center gap-5 lg:items-end">
          ...
          <div className="corner-box border border-[rgba(0,255,136,0.35)] bg-bg-card p-1 relative"
            style={{ boxShadow: '0 0 50px rgba(0,255,136,0.1)' }}>
            <div className="relative w-72 h-72">
              ...
              {/* spinning ring */}
              <div className="absolute inset-[-10px] border border-dashed border-[rgba(0,255,136,0.2)] spin-slow pointer-events-none" />
            </div>
          </div>

          {/* PROFILE CARD */}
          <div className="corner-box border border-[rgba(0,255,136,0.18)] bg-bg-card w-72">
            <div className="px-5 py-4 border-b border-[rgba(0,255,136,0.12)]">
            ...
            <div className="divide-y divide-[rgba(0,255,136,0.1)]">
              {[
                ...
                <div key={i} className="flex items-center gap-3 px-5 py-3 hover:bg-[rgba(0,255,136,0.04)] transition-colors duration-200">
      ...
      {/* STATS STRIP */}
      <div className="border border-[rgba(0,255,136,0.15)] flex flex-wrap mt-14 max-w-7xl mx-auto w-full">
